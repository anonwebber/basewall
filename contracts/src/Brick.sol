...
/// @notice 10,000 brick NFTs forming a 100x100 onchain billboard.
///         9,500 outer bricks public mint @ 0.001 ETH (FCFS, 100/wallet).
///         500 center bricks (#9,501-#10,000) reserved for dev treasury.
contract Brick is ERC721, Ownable, ReentrancyGuard {
    uint256 public constant TOTAL_SUPPLY = 10_000;
    uint256 public constant PUBLIC_SUPPLY = 9_500;
    uint256 public constant DEV_RESERVE_START = 9_501;
    ...
    /// @notice Returns (x, y) coordinates on the 100x100 grid for a given tokenId (1-indexed).
